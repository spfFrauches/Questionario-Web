        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    &nbsp; 
                    <a data-toggle="tooltip" data-placement="top" title="Visualizar Questionário" href="<?= URL_BASE ?>/questionario/visualizar/<?= $value->CodQst ?>">
                        <i class="fa fa-chrome" aria-hidden="true"></i>
                    </a>
                </td>
                <td>
                    <span class="badge badge-secondary"><?= $bancoQst->totalRespostas($value->CodQst); ?></span>
                    &nbsp;
                    <a href="<?= URL_BASE ?>/questionario/listar-respostas/<?= $value->CodQst ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
