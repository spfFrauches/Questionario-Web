...
$( function() {
    ...
    $( "#item-cx-1" ).dblclick(function() {
        alert( "Hello World!" );
    });
    
    var touchtime = 0;
    $("#item-cx-1").on("click", function() {
        if (touchtime == 0) {
            // set first click
    ...
    /* Ou seja o que é arrastado pode ser soltado aqui dentro  */       
    $( "#caixa-formulario" ).droppable({
        ...
        /* Ação quando é soltado aqui dentro (o que foi arrastado) */
    ...
    function textoSimples ($item, idPergunta) {    
        $item.fadeOut(function() {  
            /* ao montar o formulário do usuário, é criado campos html input identificaveis */
